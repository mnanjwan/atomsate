...
<html lang="en">
	...
	<head>
		...
		<link href="{{ asset('frontAssets/magnific-popup.css') }}" rel="stylesheet">
		<link href="{{ asset('frontAssets/owl.carousel.min.css') }}" rel="stylesheet">
		<link href="{{ asset('frontAssets/owl.theme.default.min.css') }}" rel="stylesheet">
	...
	<body>
		...
		<div id="page" class="page">
				 	...
				 	<!-- NAVIGATION MENU -->
				  	<div class="wsmainfull menu clearfix">
	    				<div class="wsmainwp clearfix">
	    					...
	    					<div class="desktoplogo"><a href="demo-1.html" class="logo-white"><img src="images/logo-02.png" alt="header-logo"></a></div>
	      					...
	      					<nav class="wsmenu clearfix">
	        					<ul class="wsmenu-list nav-skyblue-hover">
						        	...
						        	<li aria-haspopup="true"><a href="#">Pages <span class="wsarrow"></span></a>
						          	...
						          	<!-- SIMPLE NAVIGATION LINK -->
							    	<li class="nl-simple" aria-haspopup="true"><a href="projects.html">Projects</a></li>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-8 col-lg-6 offset-md-2 offset-lg-3">
							<div class="hero-24-txt text-center">
								...
								<!-- Button -->
								<a href="demo-1.html" class="btn btn-skyblue tra-grey-hover">Back To Home</a>
			...
			<!-- FOOTER-1
			============================================= -->
			<footer id="footer-1" class="bg-tra-blue footer division">
				<div class="container">
